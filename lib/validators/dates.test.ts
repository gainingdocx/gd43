...
function bl(over: Record<string, unknown>): NormalizedExtraction {
  return {
    ...
    fields: {
      ...
      originals_count: null, bl_type: null, clauses: [], dangerous_goods: [], _meta: META,
      ...over,
    },
...
describe("dates — invoice and packing list", () => {
  it("warns on a future invoice date", () => {
    const ci: NormalizedExtraction = {
      ...
      fields: {
        invoice_no: null, invoice_date: "01 AUG 2026", due_date: null, po_no: null,
        purchase_order_refs: [], bl_numbers: [], booking_refs: [], container_refs: [],
        seller: null, buyer: null, incoterm: null, currency: null,
        line_items: [], subtotal: null, discount_amount: null, freight_charge: null, insurance: null,
        tax_amount: null, total_amount: null, amount_due: null, payment_terms: null, lc_number: null,
        country_of_origin: null, bank_details: null, dangerous_goods: [],
  ...
  it("warns on an unreadable packing list date", () => {
    const pl: NormalizedExtraction = {
      ...
      fields: {
        ...
        container_refs: [], dangerous_goods: [], _meta: { ...META, detected_type: "packing_list" },
      },
    };
