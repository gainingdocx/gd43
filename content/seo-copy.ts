...
export const TOOL_SEO: Record<string, SeoPageCopy> = {
  "air-waybill-number-check": { title: "Free Air Waybill Number Checker | MAWB Check Digit", description: "Batch-check 11-digit Master Air Waybill numbers, airline prefixes and modulus-7 check digits. See the expected digit and export CSV.", h1: "Air Waybill Number Checker", intro: "Validate one or many airline-issued Master Air Waybill numbers using the 3-digit airline prefix, 7-digit serial and modulus-7 check digit. House AWB references are kept separate because forwarder formats vary.", headings: ["Check Master Air Waybill Numbers", "AWB Check-Digit Method and Limits", "Air Waybill Number Checker FAQ"] },
  "air-cargo-document-checklist": { title: "Air Cargo Document Checklist for Exporters & Forwarders", description: "Create an air-freight paperwork checklist for general cargo, consolidations, dangerous goods or perishables.", h1: "Air Cargo Document Checklist", intro: "Choose your role and cargo scenario to organize the core and conditional paperwork before starting a guided air export, MAWB–HAWB or dangerous-goods workflow.", headings: ["Documents for an Air Cargo Shipment", "How to Use the Airfreight Checklist", "Air Cargo Document Checklist FAQ"] },
  ...
  "chargeable-weight-calculator": { title: "Chargeable Weight Calculator | Air Freight & Courier", description: "Calculate actual, volumetric and chargeable weight per package line. Use air, express or custom divisors, rounding, freight rate and CSV export.", h1: "Air Freight Chargeable Weight Calculator", intro: "Calculate chargeable weight line by line for multiple package sizes. Compare actual and volumetric weight, choose an air-cargo, express-courier or custom divisor, apply rounding, estimate freight and export the audit.", headings: ["Actual, Volumetric and Chargeable Weight", "Air Freight Volumetric Weight Formula", "Chargeable Weight Calculator FAQ"] },
  ...
  "demurrage-detention-calculator": { title: "Demurrage & Detention Calculator | Free Time & Charges", description: "Calculate demurrage, detention or combined D&D with free days, calendar or weekday counting, date conventions, tiered rates and CSV audit.", h1: "Demurrage and Detention Calculator", intro: "Audit container free time and estimated charges using the governing events, day-count convention, free days and tiered rates. Calculate demurrage, detention or combined D&D and export the result.", headings: ["Container Free Time and Chargeable Days", "Demurrage and Detention Calculation Method", "Demurrage Calculator FAQ"] },
...
export const TEMPLATE_SEO: Record<string, SeoPageCopy> = {
  ...
  "shipping-instructions-template": { title: "Shipping Instructions Format Word | Free DOCX Template", description: "Prepare shipping instructions in an editable Word format with shipper, consignee, routing, container, cargo and B/L details. Download DOCX, XLSX or PDF.", h1: "Shipping Instructions Format for Word, Excel and PDF", intro: "Prepare complete shipper, consignee, routing, equipment, freight and cargo instructions for a carrier or freight forwarder, then download an editable Word DOCX, Excel workbook or PDF.", headings: ["Shipping Instruction Cargo Details", "Shipping Instruction Field Checks", "How to Prepare Shipping Instructions", "Shipping Instructions Template FAQ"] },
